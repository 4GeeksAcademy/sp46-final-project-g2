                    ...
                    <div className="col-md-4">
                        <div className="position-sticky" style={{ top: '2rem' }}>
                            <div className="p-4 mb-3 bg-body-tertiary rounded">
                                <h4 className="fst-italic">Sobre el autor</h4>
                                <p className="mb-0">Lola Panizo es una autora manchega reconocida por sus intrigantes novelas de misterio que transportan a los lectores a paisajes cautivadores y oscuros. </p>
                            </div>
                            <div>
