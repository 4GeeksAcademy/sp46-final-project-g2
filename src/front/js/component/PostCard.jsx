...
export const PostCard = () => {
    return (
        ...
        <div className="card-body">
          <h5 className="card-title">El mito de Sísifo</h5>
          <h6 className="card-subtitle mb-4 text-body-secondary fw-lighter"> <FontAwesomeIcon icon={faHashnode} size= "sm"/>  Ensayo - Prosa - Existencialismo </h6>
